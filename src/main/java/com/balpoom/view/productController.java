...
@SessionAttributes("Product")
	...
	public String insertProduct(MultipartHttpServletRequest req) throws IllegalStateException, IOException {
		...
		RegisterVO rvo = new RegisterVO(regdate, p_common_name);
				...
				for(int j = 0; j<size.length; j++){
					...
					if(size[j]!=null && !size[j].equals("")){
						...
						if(j==0){
							...
							ProductVO pvoO = new ProductVO(p_identifier,r_no, p_name, p_type, p_price, s_size[0], s_size[1], s_size[2], s_size[3], s_size[4], colorOpt[i], size[j], p_common_name,s_no,p_type_detail);
							System.out.println(6);
							...
							ProductVO pvoO = new ProductVO(p_identifier,r_no, p_name, p_type, p_price, m_size[0], m_size[1], m_size[2], m_size[3], m_size[4], colorOpt[i], size[j], p_common_name,s_no,p_type_detail);
							productService.insertProduct(pvoO);
							...
							ProductVO pvoO = new ProductVO(p_identifier,r_no, p_name, p_type, p_price, l_size[0], l_size[1], l_size[2], l_size[3], l_size[4], colorOpt[i], size[j], p_common_name,s_no,p_type_detail);
							productService.insertProduct(pvoO);
							...
							ProductVO pvoO = new ProductVO(p_identifier,r_no, p_name, p_type, p_price, xl_size[0], xl_size[1], xl_size[2], xl_size[3], xl_size[4], colorOpt[i], size[j], p_common_name,s_no,p_type_detail);
							productService.insertProduct(pvoO);
