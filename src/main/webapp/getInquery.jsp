...
<head>
    ...
    <title>상품문의</title>
    <link rel="stylesheet" href="./css/getBoard_Inquiry.css?ver=1">
...
<body>
        ...
        <div id="getBoardInquiry_wrapper">
            ...
            <form method="post" name="replyInsertForm">
                <table>
                <tr><td>NO.${Inquery.inqu_no}</td><td> </td></tr>
                    <tr><td>제목</td><td >${Inquery.inqu_title}</td></tr>
                    <tr><td>작성자</td><td>${Inquery.m_name}</td></tr>
                    <tr><td>작성일</td><td>${Inquery.reg_date}</td></tr>
