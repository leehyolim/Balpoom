...
<br><br><br><br><br><br><br>   
        <img id="mpTitle" src="./img/mypage_title.png" align="center">
        
        <div id="mpInfo">
            <div id="mpTextbox">

<pre id="mpText">
<font id="mpHello">000님 안녕하세요.</font>
<font size="2" color="#848484">저희 쇼핑몰을 이용해 주셔서 감사합니다:D
000님의 회원등급은 <font color="#848484"><b>새내기</b></font> 입니다.
구매시 기본적립 외 <font color="#848484"><b>0%</b></font>를 추가 적립해 드립니다.</font> 
        ...
        <div id="mpBoxes">
            <div class="mpBox" onMouseOver="this.style.backgroundColor='#FAFAFA'; "onMouseOut="this.style.backgroundColor='#FFFFFF'" div style=" cursor: pointer;">
