...
$(document).ready(function(){
  ...
  if($("#header_choice > option:selected").val()=='Bottom'){
    ...
    output +='<label>총 기 장 : </label> <input type="text" name="s1" placeholder="Enter Your Cm" maxlength="4"/><br>';
    output +='<label>허&nbsp;&nbsp;&nbsp;&nbsp; 리 : </label> <input type="text" name="s2" placeholder="Enter Your Cm" maxlength="4"/><br>';
    output +='<label>밑&nbsp;&nbsp;&nbsp;&nbsp; 위 : </label><input type="text" name="s3" placeholder="Enter Your Cm" maxlength="4"/><br>';
    output +='<label>허 벅 지 : </label> <input type="text" name="s4" placeholder="Enter Your Cm" maxlength="4"/><br>';
    output +='<label>밑&nbsp;&nbsp;&nbsp;&nbsp; 단 : </label><input type="text" name="s5" placeholder="Enter Your Cm" maxlength="4"/><br>';
